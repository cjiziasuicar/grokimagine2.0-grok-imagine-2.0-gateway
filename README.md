# Grok Imagine 2.0 API (grok-imagine-2.0 / grokimagine2.0) — gateway guide with published pricing
...
**[Live pricing](https://go.apimart.ai/k-fe443d)** · **[Get an API key](https://go.apimart.ai/k-0143be)**
